...
describe('Persona Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      ...
      nombres: 'AAAAAAA',
      apellidoPaterno: 'AAAAAAA',
      apellidoMaterno: 'AAAAAAA',
      fechaNacimiento: currentDate,
      genero: Sexo.VARON,
      estadoCivil: EstadoCivilPersona.SOLTERO,
      tipoDocumento: TipoDocumentoPersona.DNI,
      numeroDocumento: 'AAAAAAA',
      telefonoParticular: 'AAAAAAA',
      telefonoParticular1: 'AAAAAAA',
      emailPersonal: 'AAAAAAA',
      direccion: 'AAAAAAA',
    };
  });
  ...
  describe('Service methods', () => {
      ...
      const returnedFromService = Object.assign(
        {
          ...
          telefonoParticular: 'BBBBBB',
          telefonoParticular1: 'BBBBBB',
          emailPersonal: 'BBBBBB',
          direccion: 'BBBBBB',
        },
        elemDefault
      );
    ...
    describe('addPersonaToCollectionIfMissing', () => {
      ...
      it('should add only unique Persona to an array', () => {
        const personaArray: IPersona[] = [{ id: 123 }, { id: 456 }, { id: 76719 }];
