...
/**
 * Criteria class for the {@link com.creinfor.domain.Teoria} entity. This class is used
 * in {@link com.creinfor.web.rest.TeoriaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /teorias?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
public class TeoriaCriteria implements Serializable, Criteria {
    ...
    public TeoriaCriteria() {}

    public TeoriaCriteria(TeoriaCriteria other) {
    ...
    @Override
    public TeoriaCriteria copy() {
        return new TeoriaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final TeoriaCriteria that = (TeoriaCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, activo, nombre, nombreCorto, descripcion, horariosId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "TeoriaCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
