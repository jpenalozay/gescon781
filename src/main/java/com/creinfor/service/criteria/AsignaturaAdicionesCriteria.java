...
/**
 * Criteria class for the {@link com.creinfor.domain.AsignaturaAdiciones} entity. This class is used
 * in {@link com.creinfor.web.rest.AsignaturaAdicionesResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /asignatura-adiciones?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
public class AsignaturaAdicionesCriteria implements Serializable, Criteria {
    ...
    public AsignaturaAdicionesCriteria() {}

    public AsignaturaAdicionesCriteria(AsignaturaAdicionesCriteria other) {
    ...
    @Override
    public AsignaturaAdicionesCriteria copy() {
        return new AsignaturaAdicionesCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AsignaturaAdicionesCriteria that = (AsignaturaAdicionesCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, activo, nombre, nombreCorto, descripcion, asignaturaId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "AsignaturaAdicionesCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
