...
import com.creinfor.config.Constants;
import com.creinfor.domain.User;
import com.creinfor.repository.UserRepository;
import com.creinfor.security.AuthoritiesConstants;
import com.creinfor.service.MailService;
import com.creinfor.service.UserService;
import com.creinfor.service.dto.AdminUserDTO;
import com.creinfor.web.rest.errors.BadRequestAlertException;
import com.creinfor.web.rest.errors.EmailAlreadyUsedException;
import com.creinfor.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    public ResponseEntity<String> upload(@RequestParam("file") MultipartFile file) {
        try {
            ...
            String filePath = "../../../../../jlpy/Documents/Gescon/gescon781/src/main/webapp/content/images/profiles/" + fileName;
            if (file.isEmpty()) {
                return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                        .body("Please select a file to upload");
            }
            if (file.getSize() > 1024 * 1024 * 10) { // 10 MB
                return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
