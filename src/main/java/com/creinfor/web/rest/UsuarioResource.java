...
import com.creinfor.service.UsuarioQueryService;
import com.creinfor.service.UsuarioService;
...
/**
 * REST controller for managing {@link com.creinfor.domain.Usuario}.
 */
@RestController
@RequestMapping("/api")
public class UsuarioResource {
     ...
     */
    @GetMapping("/usuarios")
    public ResponseEntity<List<Usuario>> getAllUsuarios(UsuarioCriteria criteria) {
        log.debug("REST request to get Usuarios by criteria: {}", criteria);
        List<Usuario> entityList = usuarioQueryService.findByCriteria(criteria);
