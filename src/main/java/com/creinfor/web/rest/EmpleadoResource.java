...
import com.creinfor.service.EmpleadoQueryService;
import com.creinfor.service.EmpleadoService;
...
/**
 * REST controller for managing {@link com.creinfor.domain.Empleado}.
 */
@RestController
@RequestMapping("/api")
public class EmpleadoResource {
    ...
    public ResponseEntity<List<Empleado>> getAllEmpleados(EmpleadoCriteria criteria) {
        log.debug("REST request to get Empleados by criteria: {}", criteria);
        List<Empleado> entityList = empleadoQueryService.findByCriteria(criteria);
