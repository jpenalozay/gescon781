...
import com.creinfor.service.AlumnoQueryService;
import com.creinfor.service.AlumnoService;
...
/**
 * REST controller for managing {@link com.creinfor.domain.Alumno}.
 */
@RestController
@RequestMapping("/api")
public class AlumnoResource {
     ...
     */
    @GetMapping("/alumnos")
    public ResponseEntity<List<Alumno>> getAllAlumnos(AlumnoCriteria criteria) {
        log.debug("REST request to get Alumnos by criteria: {}", criteria);
        List<Alumno> entityList = alumnoQueryService.findByCriteria(criteria);
