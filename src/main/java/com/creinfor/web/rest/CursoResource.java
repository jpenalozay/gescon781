...
import com.creinfor.service.CursoQueryService;
import com.creinfor.service.CursoService;
...
/**
 * REST controller for managing {@link com.creinfor.domain.Curso}.
 */
@RestController
@RequestMapping("/api")
public class CursoResource {
     ...
     */
    @GetMapping("/cursos")
    public ResponseEntity<List<Curso>> getAllCursos(CursoCriteria criteria) {
        log.debug("REST request to get Cursos by criteria: {}", criteria);
        List<Curso> entityList = cursoQueryService.findByCriteria(criteria);
